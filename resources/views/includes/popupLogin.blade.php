                        ...
                        <div class="row text-center sign-with">
                            ...
                            <div class="col-md-12">
                                <div class="btn-group btn-group-justified">
                                    <div style="float: left"><a href="#" class="btn btn-primary">Facebook</a></div>
                                    <div style="float: left"><a href="#" class="btn btn-danger">Google</a></div>
                                    <div><a href="#" class="btn btn-info">Twitter</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
